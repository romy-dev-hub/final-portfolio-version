    ...
    <section id="skills" className="py-20 bg-background dark:bg-dark-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-primary dark:text-gray-300 max-w-2xl mx-auto">
        ...
        >
          {skillCategories.map((category, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-dark-secondary rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border border-secondary/20 dark:border-dark-secondary"
            >
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                {category.icons.map((IconComponent, iconIndex) => (
                  <div
                    key={iconIndex}
                    className="w-10 h-10 rounded-lg bg-background dark:bg-dark-primary flex items-center justify-center text-primary dark:text-white border border-secondary/20 dark:border-dark-secondary"
                  >
